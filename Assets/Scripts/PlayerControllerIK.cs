...
namespace Bleak.Controller
{
    ...
    public class PlayerControllerIK : MonoBehaviour
    {
        ...
        public UnityEngine.CharacterController _characterController;
        ...
        {
            sleeping = false;
            var go = Instantiate(textPrefab, transform.position + new Vector3(0, 2.594f, 0), Quaternion.identity, transform);
